...
namespace Calculator.WindowsUi.Common
{
    public class ObservableObject: INotifyPropertyChanged
    {
        ...
        protected virtual bool SetProperty<TProperty>(ref TProperty fieldOfProperty, TProperty value,
        ...
        private string GetPropertyName<TProperty>(Expression<Func<TProperty>> expression)
        {
            ...
            {
                throw new NotSupportedException("Esperada una expresión lambda que representa una propiedad.");
            }
